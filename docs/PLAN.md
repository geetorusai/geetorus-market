...
| Dimension | Claw Mart (Reference) | GeeTorus (Our Product) |
|---|---|---|
...
| Install target | One agent's config files | Geetorus company (agents, projects, governance) |
...
| Install flow | Drop file into workspace | One-click deploy to Geetorus company |
